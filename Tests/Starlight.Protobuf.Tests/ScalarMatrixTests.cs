...
public sealed class ScalarMatrixTests
{
    ...
    private static byte[] Oracle(ScalarMatrix m)
    {
        ...
        o.WriteTag(101, WireFormat.WireType.Varint); o.WriteInt32(m.FInt32);
        o.WriteTag(102, WireFormat.WireType.Varint); o.WriteInt64(m.FInt64);
        o.WriteTag(103, WireFormat.WireType.Varint); o.WriteUInt32(m.FUint32);
        o.WriteTag(104, WireFormat.WireType.Varint); o.WriteUInt64(m.FUint64);
        o.WriteTag(105, WireFormat.WireType.Varint); o.WriteSInt32(m.FSint32);
        o.WriteTag(106, WireFormat.WireType.Varint); o.WriteSInt64(m.FSint64);
        o.WriteTag(107, WireFormat.WireType.Fixed32); o.WriteFixed32(m.FFixed32);
        o.WriteTag(108, WireFormat.WireType.Fixed64); o.WriteFixed64(m.FFixed64);
        o.WriteTag(109, WireFormat.WireType.Fixed32); o.WriteSFixed32(m.FSfixed32);
        o.WriteTag(110, WireFormat.WireType.Fixed64); o.WriteSFixed64(m.FSfixed64);
        o.WriteTag(111, WireFormat.WireType.Varint); o.WriteBool(m.FBool);
        o.WriteTag(112, WireFormat.WireType.Fixed32); o.WriteFloat(m.FFloat);
        o.WriteTag(113, WireFormat.WireType.Fixed64); o.WriteDouble(m.FDouble);
        o.WriteTag(114, WireFormat.WireType.LengthDelimited); o.WriteString(m.FString);
        o.WriteTag(115, WireFormat.WireType.LengthDelimited); o.WriteBytes(m.FBytes);
        o.Flush();
